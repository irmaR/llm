...
/*
	...
	public static void main(String[] args) throws Exception{
		...
		Propositionalized_Cell_Hybrid_intrinsic propositionalizedPKK=new Propositionalized_Cell_Hybrid_intrinsic();
		...
		if(res.getString("type_of_data").equals("train")){
			...
			data=dataLoader.loadDataNoSubSampling(res.getString("input_path"), "fold", "pl",propositionalizedPKK.getNtwInfo());
        ...
        System.out.println(" Predicate: "+res.getString("predicate"));
