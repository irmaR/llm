...
public class Evaluate_hybrid_cell {
...
/*
	...
	ArgumentParser parser = ArgumentParsers.newArgumentParser("prog")
		    ...
		    rmse.add(ntw.getAtom("cell_doublingtime"));
		    rmse.add(ntw.getAtom("cell_lengthatbirth"));
		    rmse.add(ntw.getAtom("cell_avglength"));
		    rmse.add(ntw.getAtom("cell_lengthgrowthrate"));
