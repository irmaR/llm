...
public class Box_learning{
	...
	public static void main(String[] args) throws Exception{
		...
		exclusion_goal_reached.add(ntw.getPredicateNameToAtom().get("arm_finger_cur").getPredicate());
		
		List<Predicate> exclusion_pos_x_next=new ArrayList<Predicate>();
		exclusion_pos_x_next.add(ntw.getPredicateNameToAtom().get("arm_y_next").getPredicate());
		exclusion_pos_x_next.add(ntw.getPredicateNameToAtom().get("arm_z_next").getPredicate());
		...
		exclusion_pos_x_next.add(ntw.getPredicateNameToAtom().get("arm_x_next").getPredicate());
		...
		exclusion_pos_y_next.add(ntw.getPredicateNameToAtom().get("arm_y_next").getPredicate());
		exclusion_pos_y_next.add(ntw.getPredicateNameToAtom().get("arm_z_next").getPredicate());
		...
		exclusion_pos_y_next.add(ntw.getPredicateNameToAtom().get("arm_x_next").getPredicate());
		...
		exclusion_pos_z_next.add(ntw.getPredicateNameToAtom().get("arm_y_next").getPredicate());
		exclusion_pos_z_next.add(ntw.getPredicateNameToAtom().get("arm_z_next").getPredicate());
		...
		exclusion_pos_z_next.add(ntw.getPredicateNameToAtom().get("arm_x_next").getPredicate());
