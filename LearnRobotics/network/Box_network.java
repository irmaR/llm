...
public class Box_network {
	...
	GaussianPred arm_roll_pred=new GaussianPred("arm_roll",1);
	GaussianPred arm_pitch_pred=new GaussianPred("arm_pitch",1);
	GaussianPred arm_yaw_pred=new GaussianPred("arm_yaw",1);
	...
	return new NetworkInfo(new Atom[]{arm_finger_next,arm_finger,x_cur,y_cur,z_cur,x_next,y_next,z_next,arm_x,arm_y,arm_z,arm_roll,arm_pitch,arm_yaw,arm_x_next,arm_y_next,arm_z_next,arm_roll_next,arm_pitch_next,arm_yaw_next},new Type[]{objects,arms});	   		
	}
}
