...
public class Transition_network_Version2 {
	...
	//-------------------------------------------------------------------------------
		...
		return new NetworkInfo(new Atom[]{yaw_next,pitch_next,roll_next,arm_x_cur,arm_y_cur,arm_z_cur,arm_roll_cur,arm_pitch_cur,arm_yaw_cur,arm_finger,arm_x_next,arm_y_next,arm_z_next,arm_roll_next,arm_pitch_next,arm_yaw_next,arm_finger_next,x_cur,y_cur,z_cur,x_next,y_next,z_next,yaw_cur,pitch_cur,roll_cur},new Type[]{objects,arms});	   		
		}
}
