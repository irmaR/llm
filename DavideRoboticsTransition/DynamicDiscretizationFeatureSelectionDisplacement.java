...
import hybrid.structureLearning.DTWithFeatureSelectionDynamicDiscretization;
...
public class DynamicDiscretizationFeatureSelectionDisplacement {
	...
	public static void main(String[] args) throws Exception{
		...
		int counter=0;
		int[] indices=null;
		DTWithFeatureSelectionDynamicDiscretization dpSelector=new DTWithFeatureSelectionDynamicDiscretization(AlgorithmParameters.getScriptOutput(),new PenalizeDiscreteFeatures(),AlgorithmParameters.discretization_level,new DisplacementFeatures(),ntw);
		...
		indices=new int[]{0, 1, 9, 324, 175, 27, 187, 330, 128, 139, 251, 322, 57, 183, 174, 172, 345, 86, 320, 36};
