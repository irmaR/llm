...
public class SplitDiscreteFeaturesAllInLR {
	...
	public static void main(String[] args) throws Exception{
		...
		//}
		DecisionTreeLearning dtl=new DecisionTreeLearning(new DTDependencySelectorSplitDiscreteAllFeatures(new String[]{"/usr/bin/python",AlgorithmParameters.getExternalScript()+"/regression.py"},AlgorithmParameters.output_path));
		StructureLearner str_learner=new StructureLearner(fGen,dtl,ntw,training_data_machine,validation_machine,test_machine);	
		//int[] indices=new int[]{0, 14,15};
