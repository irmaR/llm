...
public class STDiscreteAndContinuous {
	...
	public static void main(String[] args) throws Exception{
		...
		fGen.setExclusionPredicates(exclusion_predicates);
        System.out.println("Script output: "+AlgorithmParameters.getScriptOutput());
		int counter=0;
		DTDependencySelectorStandardWithScript dpSelector=new DTDependencySelectorStandardWithScript(new String[]{"/usr/bin/python"},AlgorithmParameters.getScriptOutput(),new PenalizeAggregatesAndOperators());
		...
		//int[] indices=new int[]{3,102,38,75,85,157,418};
		...
		/*for(Atom a:trees.getLearnedDependency().keySet()){
			try
			{
				...
				fw1.append(String.valueOf(test_machine.getData().getNrGroundingsInData(a)));
				fw1.close();
				...
				fw4.append(String.valueOf(accNormError/nr_leavesNonZero));
