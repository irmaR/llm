...
public class STStandardContinuous {
	...
	public static void main(String[] args) throws Exception{
		...
		List<Feature> extra_features_pos_x_next=next_arm_extra_features.getListOfFeaturesWithOrientationWithoutDiscrete(ntw.getPredicateNameToAtom().get("pos_x_next"), ntw,training_data_machine);
		List<Feature> extra_features_pos_y_next=next_arm_extra_features.getListOfFeaturesWithOrientationWithoutDiscrete(ntw.getPredicateNameToAtom().get("pos_y_next"), ntw,training_data_machine);
		List<Feature> extra_features_pos_z_next=next_arm_extra_features.getListOfFeaturesWithOrientationWithoutDiscrete(ntw.getPredicateNameToAtom().get("pos_z_next"), ntw,training_data_machine);
