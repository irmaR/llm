...
public class DiscreteFeaturesOnlyDisplacement {
	...
	public static void main(String[] args) throws Exception{
		...
		if(AlgorithmParameters.getPredicate_names().contains("pos_x_next")){
			...
			List<Feature> fts=next_arm_extra_features.getListOfFeaturesWithDisplacementOnlyDiscreteFeatures(ntw.getPredicateNameToAtom().get("pos_x_next"), ntw,training_data_machine);
		...
		if(AlgorithmParameters.getPredicate_names().contains("pos_y_next")){
			...
			extra_features_pos_y_next.addAll(next_arm_extra_features.getListOfFeaturesWithDisplacementOnlyDiscreteFeatures(ntw.getPredicateNameToAtom().get("pos_y_next"), ntw,training_data_machine));
			System.out.println("Finished ...");
		}
		if(AlgorithmParameters.getPredicate_names().contains("pos_z_next")){
			...
			extra_features_pos_z_next.addAll(next_arm_extra_features.getListOfFeaturesWithDisplacementOnlyDiscreteFeatures(ntw.getPredicateNameToAtom().get("pos_z_next"), ntw,training_data_machine));
			System.out.println("Finished ...");
		}
